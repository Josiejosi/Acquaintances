    	...
    	<div id="upload">
            ...
            <div class="row">
				...
				<div class="col-md-12">
					...
					<h1 class="page-title"><span>Users </span> Report</h1>
					<p class="pull-right">
						<a href="{{ url( 'pdf/users_in_system' ) }}" target="_blank" class="btn btn-xs btn-danger">
				    ...
				    <div class="panel panel-info">
				        ...
				        <div class="panel-heading">
				            ...
				            <i class="fa fa-line-chart" aria-hidden="true"></i> &nbsp; Users in the system
